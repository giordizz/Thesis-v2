...
//	}
	...
	public void tagAll(int topK) throws FileNotFoundException, UnsupportedEncodingException{
		String ss = "../Thesis/data/initialBestAll/results_"+ setName  +".txt";
...
//			}
		...
		System.err.println("results written on  -> " + ss);
	}
...
//	
	...
	public void tagAll2(int topK, int firstN) throws FileNotFoundException, UnsupportedEncodingException{
		System.err.println("************** Start tagging! **************");
...
//////				System.exit(0);
////			}
//			ArrayList<Integer> topKs = getTopKSimilarEntity2(entities,21);
...
//			Exception in thread "main" java.lang.IndexOutOfBoundsException: Index: 414, Size: 414
//	        at java.util.ArrayList.rangeCheck(ArrayList.java:635)
//	        at java.util.ArrayList.get(ArrayList.java:411)
//	        at it.giordizz.Thesis.RisalitaCounting.tagAll2(RisalitaCounting.java:451)
//	        at it.giordizz.Thesis.GathererClassifier.main(GathererClassifier.java:95)
...
//		JSONArray json= (JSONArray)JSONValue.parse(new InputStreamReader(new FileInputStream("C:\\Users\\giordano\\WorkspaceJava\\TfIdf\\data\\training_similarity.JSON")));
//		Iterator<JSONObject> i =json.iterator();
//		int count = 0;
//		
//		
...
//				if (count==10) break;
////			}
////			((JSONArray) q.get("bolds")).g
////			String a = (String) ((Map.Entry)json.get(count)).getKey();
//			
////			String query = (String) q.get("query");
//			System.out.println(q.toJSONString());
//		}
...
//				r.getStatus(0);
				...
				for  (int topK=21;topK<22; topK+=2){
